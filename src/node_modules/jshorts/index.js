...
function jSh(src, first, test) {
  var document;

  if (typeof document === "undefined" && this !== lces.global) {
...
jSh.type = function(obj) {
  ...
  return type.slice(8).slice(0, -1).toLowerCase();
};
...
// Namespace regex's
var _nsCheckReg   = /^ns:[\w\d_\-]+:[^]+$/i;
var _nsExtractReg = /^ns:([\w\d_\-]+):[^]+$/i;
...
jSh.d = function node(className, text, child, attributes, properties, events) { // For creating an element
  ...
  if (!this.lcesElement) {
    ...
    if (this.lcesType) {
      var nsCheck = _nsCheckReg.test(this.lcesType);
      ...
      if (!nsCheck) {
        ...
        var nsElm = this.lcesType.replace(_nsExtractReg, "$1");
...
/**
 * @typedef {Function.<string, Function>} SVGFunc
 */
 ...
 * @type {SVGFunc}
 */
jSh.svg = function(classname, width, height, children) {
  return jSh.c("ns:svg:http://www.w3.org/2000/svg", classname, null, children, { // Attributes
    "version": "1.1",
    "width": width,
    "height": height
  });
...
jSh.path = function(classname, points, style) {
  return jSh.c("ns:path:http://www.w3.org/2000/svg", classname, null, null, {
    "ns:d:": points,
    "ns:style:": style || ""
  });
};
 ...
 * @type {Function}
 */
jSh.svg.rect = function(classname, props, evt) {
  var attrDump = {};

  if (jSh.type(props) === "object") {
    // <rect x="60" y="10" rx="10" ry="10" width="30" height="30"/>
    ["x", "y", "rx", "ry", "width", "height", "style"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  }

  return jSh.c("ns:rect:http://www.w3.org/2000/svg", classname, null, null, attrDump, null, evt);
};

// Create SVG circle
jSh.svg.circle = function(classname, props, evt) {
  var attrDump = {};

  if (jSh.type(props) === "object") {
    // <circle cx="25" cy="75" r="20"/>
    ["cx", "cy", "r", "style"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  ...
  return jSh.c("ns:circle:http://www.w3.org/2000/svg", classname, null, null, attrDump, null, evt);
};

// Create SVG group
jSh.svg.g = function(classname, children, props, evt) {
  var attrDump = {};

  if (jSh.type(props) === "object") {
    // <g transform="scale(x y) ..."/>
    ["transform", "style"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  ...
  return jSh.c("ns:g:http://www.w3.org/2000/svg", classname, null, children, attrDump, null, evt);
};

// Create SVG text
jSh.svg.text = function(classname, text, props, evt) {
  var attrDump = {};
  var textNode = text && typeof text === "object" && text || document.createTextNode(text || "");

  if (jSh.type(props) === "object") {
    // <text x="0" y="35" font-family="Verdana" font-size="35">${ text }</text>
    ["x", "y", "dx", "dy", "transform", "style", "font-size", "font-family", "text-anchor", "stroke", "stroke-width", "fill"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  ...
  return jSh.c("ns:text:http://www.w3.org/2000/svg", classname, null, textNode, attrDump, null, evt);
};

// Create SVG text
jSh.svg.tspan = function(classname, text, props, evt) {
  var attrDump = {};
  var textNode = text && typeof text === "object" && text || document.createTextNode(text || "");

  if (jSh.type(props) === "object") {
    // <text x="0" y="35" font-family="Verdana" font-size="35">${ text }</text>
    ["x", "y", "dx", "dy", "transform", "style", "font-size", "font-family", "stroke", "stroke-width", "fill"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  ...
  return jSh.c("ns:tspan:http://www.w3.org/2000/svg", classname, null, textNode, attrDump, null, evt);
};

// Create SVG polyline
jSh.svg.polyline = function(classname, points, props, evt) {
  var attrDump = {};

  if (jSh.type(props) === "object") {
    // <polyline fill="none" stroke="black" points="20,100 40,60 70,80 100,20"/>
    ["transform", "style", "stroke", "stroke-width", "fill"].forEach(function(attr) {
      if (attr in props) {
        attrDump["ns:" + attr + ":"] = props[attr];
      }
    });
  ...
  attrDump["ns:points:"] = "" + (points || "");

  return jSh.c("ns:polyline:http://www.w3.org/2000/svg", classname, null, null, attrDump, null, evt);
};
...
var getChild = jSh.getChild = function(off, length) {
  ...
  var check = [];
  var ELM_NODE = 1; // Node.ELEMENT_NODE;
...
jSh.determineType = function(obj, jShDetermine) {
  ...
  if (typeof Node === "undefined" || obj instanceof Node || obj instanceof HTMLDocument && jShDetermine)
    return obj;
